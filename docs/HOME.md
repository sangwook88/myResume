...
> 범위: [roadmap](roadmap.md) **현재 타깃 v3**. v1·v2 구현 완료(2026-07-08) — v2(경험 심화: Evidence 고급 UI·모드 토글·하이브리드 둘러보기)는 새 도메인이 아니라 기존 fe/browse·fe/chat·be/chat에 확장으로 반영됨. v3(자동화·RAG) 기능은 버전 게이트에 막혀 아직 도메인으로 가르지 않음.
