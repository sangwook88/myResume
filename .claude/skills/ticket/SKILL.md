...
도메인을 자기완결 티켓으로 그릴하고 의존 순서를 그린다. 전제: [qa](../qa/SKILL.md) 통과 + [arch](../arch/SKILL.md)로 `docs/arch/ARCHITECTURE.md` 확정. 규약: [docs/conventions.md](.claude/docs/conventions.md). 산출: `tickets/<fe|be>/NNNN-<slug>.md`.
