...
## 구성
- [데이터.md](데이터.md) — 포폴포인트(M) + Evidence(근거) + **Invidence(v4 숨은 층)** + status enum
...
- [기능_포인트단건조회.md](기능_포인트단건조회.md) — id 기준 published 포인트 단건(9섹션+Evidence, **invidence 제외**) (포인트상세)
- [기능_챗봇컨텍스트조회.md](기능_챗봇컨텍스트조회.md) — **(v4)** be/chat 전용: visible+invidence 합집합 (챗봇만)
- [기능_발행코드추출.md](기능_발행코드추출.md) — **(v4)** 발행 시 1회 커밋 ref→코드를 invidence.code에 추출
