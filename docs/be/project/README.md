...
## 구성
- [데이터.md](데이터.md) — 프로젝트(index 표지)(M) + **아키텍처 도식(typst→SVG) 애셋 (v4)**
- [기능_프로젝트목록조회.md](기능_프로젝트목록조회.md) — 랜딩 하단 프로젝트 카탈로그 (fe/browse 랜딩)
- [기능_프로젝트인덱스조회.md](기능_프로젝트인덱스조회.md) — project 기준 표지 데이터 + published 포인트 목록 조립 (프로젝트인덱스). **v4: architectureDiagram(SVG) 함께 반환**
- [기능_도식컴파일.md](기능_도식컴파일.md) — **(v4)** 빌드 시 1회 typst 소스→SVG 컴파일, 표지 architectureDiagram 채움
